...
int main(int argv, char *argc []){
    ...
    */
    ...
    for(t = 0; t < 20; t = t + delta){
        ...
        update_CommandBlock(command_block,block_trajectory_X,block_trajectory_Y,reference_change_block,1.0f);

        // To calculate v* and w*

        update_M_inverseBlock(inverse_matrix_block, command_block, robot_paramaters, itegrator_block.theta);
        ...
        update_CoordsHead(reference_change_block, itegrator_block ,robot_paramaters);
